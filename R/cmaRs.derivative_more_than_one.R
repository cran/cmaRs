...
# this function take derivative of a BF with respect to 
# ith and then jth x and assign it to DMS
...
# j: jth x
  {  
     ...
     derv1 <- D(first_part, second_part) #take derivative with respect to ith x.
     derv2 <- D(derv1, third_part) #take derivative with respect to jth x.
