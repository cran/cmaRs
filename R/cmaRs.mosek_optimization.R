...
# this function estimates the parameters of the cmars 
# model for different sqrtz values
# i: counter
# numBF: total number of basis functions
# sqrtz: the upper bound of the second constraint
# Tm:estimated parameters of the current model
# l: number of BFs in the current model
# alpha: vector of number of parameters in for all sqrtz values
# z: vector of RSS values for all sqrtz values
# t: vector of norm L Theta values for all sqrtz values
...
z = z, BasisFunctions = BasisFunctions)) #output
